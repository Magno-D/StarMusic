...
client.on('message', message => {
    var prefix = "=";
      ...
      if (message.author.id == 412683473522786324) return;
    
    
    if (message.content.startsWith(prefix + 'playing')) {
    if (message.author.id !== '412683473522786324') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
    ...
    if (message.content.startsWith(prefix + 'setnm')) {
    if (message.author.id !== '412683473522786324') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
